...
class SearchTable {
    ...
    public function get($table, $columns, $Search_columns, $sJoin = null, $where = null) {
        ...
        $productos = DB::select(DB::raw("SELECT SQL_CALC_FOUND_ROWS `".str_replace(" , ", " ", implode("`, `", $columns))."`,
